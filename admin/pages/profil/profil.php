...
$id = $_SESSION['id_penguna'];

$stmt = $conn->prepare("SELECT * FROM penguna WHERE id_penguna = ?");
$stmt->execute([$id]);
$pengguna = $stmt->fetch();
?>
            ...
            <div class="card-body p-4">
              ...
              <div class="row align-items-center mb-4">
                <div class="col-md-4 text-center border-end">
                  <img src="../../asset/images/profil/profil.svg"
                      class="rounded-circle mb-3"
                      width="120"
                      alt="Foto Profil">

                  <h5 class="fw-bold mb-1">
                  <?= $_SESSION['nama_penguna']; ?>
                  </h5>
                </div>
                  ...
                  <table class="table table-sm table-borderless mb-0">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>: <?= htmlspecialchars($pengguna['alamat_penguna']); ?></td>
                      </tr>
                      <tr>
                        <td class="fw-semibold text-muted">Email</td>
                        <td>: <?= htmlspecialchars($pengguna['email_penguna']); ?></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <div class="mb-4">
                ...
                <i class="mdi mdi-information-outline text-primary"></i> Status Penguna
                </h6>
                <p class="text-muted mb-0">
                  <?= nl2br(htmlspecialchars($pengguna['status'])); ?>
                </p>
              </div>
